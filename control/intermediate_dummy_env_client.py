...
print("Connecting to intermediate dummy env server…")
...
class IntermediateDummyEnvClient(object):

    def __init__(self, disc_thetas=False):
        print("CREATING INTERMEDIATE DUMMY ENV CLIENT - SHOULD ONLY BE HERE ONCE")
